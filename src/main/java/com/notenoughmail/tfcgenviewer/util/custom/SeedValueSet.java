...
public record SeedValueSet(Font font, Consumer<String> seedSetter, Supplier<String> defaultValue, Consumer<Runnable> seedTick) implements OptionInstance.ValueSet<String> {
